...
class FetchPixels {
  ...
  {
    return FetchPixels.getPixelWidth(6);
  }
  static double getnullList(BuildContext context)
  {
    return FetchPixels.getPixelWidth(100);
  }


  static double getpresentCard(BuildContext context)
  {
    return FetchPixels.getPixelWidth(16);
  }
